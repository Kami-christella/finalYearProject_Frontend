...
//         // If we didn't get recommendations from localStorage, fetch them
//         if (!storedRecommendations) {
...
// //      const academicResponses = JSON.parse(localStorage.getItem('academicResponses') || '{}');
// // const homeLearningResponses = JSON.parse(localStorage.getItem('homeLearningResponses') || '{}');
// // const responses = JSON.parse(localStorage.getItem('emotionalResponses') || '{}');
...
//                         {
//                             role: "user",
//                             content: `Based on the following assessments, provide pieces of advice:\n\nCareer Test:\n${JSON.stringify(academicResponses)}\n\nSkills Assessment:\n${JSON.stringify(homeLearningResponses)}\n\nEmotional Wellbeing Assessment:\n${JSON.stringify(responses)}`
//                         }
//                         ]
//                     },
//                     {
...
//         if (recommendationsResponse.data.recommendations) {
//   setRecommendations(recommendationsResponse.data.recommendations);
//   localStorage.setItem('AIRecommendations', JSON.stringify(recommendationsResponse.data.recommendations));
// }
